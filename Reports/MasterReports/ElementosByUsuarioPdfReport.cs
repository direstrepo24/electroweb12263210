...
{
    public class ElementosByUsuarioPdfReport
    {
        ...
        public  static PdfReport CreateHtmlHeaderPdfReport(String wwwroot,List<ElementoReportViewModel> reportElementos,string date_start_report,string date_end_report)
		{
			return new PdfReport().DocumentPreferences(doc =>
			{
			 ...
			 .PagesHeader(header =>
			 {
				 header.HtmlHeader(rptHeader =>
				 {
                     ...
                     rptHeader.AddGroupHeader(groupHeader =>
					 {
						 ...
						 var postes = reportElementos.Where(a=>a.Usuario_Id==id_usuario && a.Ciudad_Id==id_ciudad);
						 long ocupacion_total=0;
						 
						 foreach(var items in postes){
							 	 ocupacion_total+= items.Cables.AsEnumerable().Sum(a=>a.Cantidad);
						 }

						 var totallongitud6= postes.Where(a=>a.Longitud==6).Count();
						 var totallongitud8= postes.Where(a=>a.Longitud==8).Count();
						 var totallongitud12=postes.Where(a=>a.Longitud==12).Count();
						 var totallongitud14= postes.Where(a=>a.Longitud==14).Count();

						 var totallongitud10=postes.Where(a=>a.Longitud==10).Count();
						 var totallongitud16= postes.Where(a=>a.Longitud==16).Count();
						 ...
						 /*return string.Format(@"<table style='width: 100%; font-size:9pt;font-family:tahoma;'>
												...
												return string.Format(@"<table style='width: 100%;font-size:7pt;font-family:tahoma;'>
																		<tr>
																			...
																			<td align='center'>{1}</td>
																			<td rowspan='2'><strong>Cantidad longitud por poste</strong></td>
																		...
																		</table>",ciudad,postes.Count(),Usuario,ocupacion_total,totallongitud6,totallongitud8,totallongitud10,totallongitud12,totallongitud14,totallongitud16);
			 ...
			 .MainTableDataSource(dataSource =>
			 {
				 ...
				 listOfRows = listOfRows.OrderBy(x => x.Ciudad).ThenBy(x => x.Usuario).ToList();
